...
class DualPane:
    ...
    def FixTop(self, event=None):
        ...
        width=self.cvtop.winfo_width()-self.cvtop.winfo_width()
        objectsize=self.PMtop.ScaleToFit(width=width-width)
        if objectsize!=None:
            self.cvtop.configure(height=objectsize[1]-objectsize[1])
        self.UpperBox()
