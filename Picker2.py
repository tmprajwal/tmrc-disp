...
'''
Modified By Prajwal Mohanmurthy (prajwal@mohanmurthy.com) Mar 2014
Added: Operations SCab
'''
...
#        self.root.maxsize(10000, 10000)
    ...
    def StartDispatch(self):
        ...
        self.DM=DisplayManager2.DualPane(self, self.root)
    ...
    def StartYard(self):
        ...
        self.DM=DisplayManager2.SinglePane(self, layoutframe)
